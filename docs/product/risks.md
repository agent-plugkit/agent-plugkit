...
- **协议与平台格式演进**：Agent Plugins、GitHub Copilot/VS Code、Cursor、Claude Code、Codex 与 Grok Build 的 manifest/index 格式可能继续变化。缓解：固定 portable 协议版本、以 adapter 边界隔离客户端细节、vendor 当前协议 schema，并以官方文档和 marketplace fixture 作为生成契约证据；格式变化时同步 adapter、fixture 与公开文档。
